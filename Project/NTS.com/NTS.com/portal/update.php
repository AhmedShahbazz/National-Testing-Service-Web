        ...
        while ($result = mysqli_fetch_assoc($data)) {
           ...
           // echo ('url is : ' . $url);
            ...
            <tr>
                ...
                <td>".$result['resume']."</td>
                <td><a href ='updatesss.php?rn=$result[id]&fn=$result[first_name]&ln=$result[last_name]
                &tn=$result[test_name]&pn=$result[phone_number]&ad=$result[address]&tbl=apps'>Update</td>
            </tr>";
        }
        ...
        while ($result = mysqli_fetch_assoc($data)) {
           ...
           // echo ('url is : ' . $url);
            ...
            <tr>
                ...
                <td>".$result['resume']."</td>
                <td><a href ='updatesss.php?rn=$result[id]&fn=$result[first_name]&ln=$result[last_name]
                &tn=$result[test_name]&pn=$result[phone_number]&ad=$result[address]&tbl=ap'>Update</td>
            </tr>";
        }
        ...
        while ($result = mysqli_fetch_assoc($data)) {
           ...
           // echo ('url is : ' . $url);
            ...
            <tr>
                ...
                <td>".$result['resume']."</td>
                <td><a href ='updatesss.php?rn=$result[id]&fn=$result[first_name]&ln=$result[last_name]
                &tn=$result[test_name]&pn=$result[phone_number]&ad=$result[address]&tbl=js'>Update</td>
            </tr>";
        }
